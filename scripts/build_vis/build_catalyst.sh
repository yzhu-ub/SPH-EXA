...
SPHEXA_ROOT="$1/../"
PARAVIEW_INSTALLATION_DIR="/home/appcell/unibas/paraview/install"
cd $SPHEXA_ROOT/sphexa-catalyst
rm -rf ./*
cmake -Dcatalyst_DIR=$PARAVIEW_INSTALLATION_DIR/lib/cmake/catalyst-2.0 -DParaView_CATALYST_DIR=$PARAVIEW_INSTALLATION_DIR/lib/catalyst -DCMAKE_BUILD_TYPE=Debug -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DCMAKE_CXX_COMPILER=mpicc -DCMAKE_CXX_COMPILER=mpicxx -DINSITU=Catalyst -DSPH_EXA_WITH_H5PART:BOOL=OFF -S ../SPH-EXA
cd $SPHEXA_ROOT/sphexa-catalyst
make -j 16
rm -f $SPHEXA_ROOT/sphexa-vis/output_catalyst/*
